...
public class ArtworkManagement{
    ...
    */
    public static void main(String[] args) throws IOException {
        ...
        // paintings.addFirst( new Artwork("100", "Andres", 2012, "Boston") );
        // sculptures.addFirst( new Sculpture("100", "Andres", 2012, "Boston", "wood", 23, 34) );
        // paintings.addLast( new Artwork("101", "Andres", 2012, "Boston") );
        // sculptures.addLast( new Sculpture("101", "Andres", 2012, "Boston", "wood", 23, 34) );
